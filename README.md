...
- 1편 원고: [`docs/stage1-blog-post.md`](docs/stage1-blog-post.md)
...
2편에서는 YAML을 직접 작성하지 않고 **Maestro Studio**로 화면을 보면서 시각적으로 테스트를 만드는 방법을 다룰 예정입니다. 자세한 계획은 [`docs/blog-plan.md`](docs/blog-plan.md)를 참고하세요.
