...
![카운터 초기 화면](../screenshots/app_initial.png)
*앱을 처음 실행한 모습 (카운트 0)*

![카운터 증가된 화면](../screenshots/app_incremented.png)
*+1 버튼을 세 번 누른 모습 (카운트 3)*

![10 달성 화면](../screenshots/app_milestone.png)
*+1을 열 번 눌러 10에 도달하면 축하 메시지가 나타난다*
